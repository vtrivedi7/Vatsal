        ...
        <div className="container-custom">
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1">
              ...
              <div className="mb-6">
                <AnimatedText
                  text="AI builder and product leader"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <AnimatedSection delay={0.2}>
              ...
              <p className="text-lg font-light text-foreground/80 leading-relaxed">
                The bottleneck isn't extraction. It's review, trust, and making human judgment reusable at scale.
              </p>
            </AnimatedSection>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <AnimatedSection delay={0.2}>
              ...
              <p className="text-lg md:text-xl font-light text-foreground/80 leading-relaxed">
                Better systems make review scale with ambiguity, not volume. Human judgment compounds instead of being
                throwaway labor.
              </p>
            </AnimatedSection>
          </div>
        ...
        <div className="container-custom text-center">
          ...
          <AnimatedSection delay={0.2}>
            <p className="text-lg md:text-xl font-light mb-8 max-w-2xl mx-auto text-foreground/80 leading-relaxed">
              I've lived this problem at Meta, Dirac, and Bridge. I'm focused on building the systems that should have existed.
            </p>
